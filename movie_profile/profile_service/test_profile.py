from profile_service.app_profile import app as test_app
from profile_service.app_profile import db as test_db
from profile_service.database_profile import profile
import unittest
import json
...
class TestProfile(unittest.TestCase):
    def setUp(self):
        ...
        self.db = test_db
        self.db.create_all()
        self.db.session.add(profile(profile_id=1, movie_name="A star is born", profile_number=50))
        self.db.session.add(profile(profile_id=2, movie_name="Escape Room", profile_number=30))
    ...
    def test_get_all_profiles(self):
        ...
        self.assertDictEqual(profile_list[0], {"profile_id": "1", "movie_name": "A star is born", "profile_number": "50"})
        self.assertDictEqual(profile_list[1], {"profile_id": "2", "movie_name": "Escape Room", "profile_number": "30"})
    ...
    def test_get_profile_with_valid_name(self):
        ...
        self.assertDictEqual(person, {"profile_id": "2", "movie_name": "Escape Room", "profile_number": "30"})
    ...
    def test_get_profile_with_valid_id(self):
        ...
        self.assertDictEqual(profile, {"profile_id": "1", "movie_name": "A star is born", "profile_number": "50"})
    ...
    def test_create_profile_with_new_id(self):
        ...
        # send the request and check the response status code
        response = self.app.put("/profile", data={"profile_id": 3, "movie_name": "The Upside", "profile_number": 65})
        self.assertEqual(response.status_code, 200)
        ...
        self.assertEqual(profile.movie_name, "The Upside")
    ...
    def test_update_profile_with_invalid_id(self):
        ...
        response = self.app.put("/profile/update", data={"profile_id": 1000000,
                                                        "movie_name": "Invalid profile ID",
                                                        "profile_number": 555})

        self.assertEqual(response.status_code, 404)

    # Testing exist profile update by movie name
    def test_update_profile_without_id(self):
        # send the request and check the response status code
        response = self.app.put("/profile/update", data={"movie_name": "A star is born", "profile_number": 10})
    ...
    def test_delete_profile_with_valid_id(self):
        ...
        # send the request and check the response status code
        create_response = self.app.put("/profile", data={"profile_id": 3, "movie_name": "The Upside", "profile_number": 65})
